...
Текущая версия рабочей ветки: `1.5.0` (adaptive Auto routing).
...
В `v1.5.0` режим **Авто** стал адаптивным: runtime учитывает профиль сети (Wi‑Fi / mobile), статистику успехов/ошибок по маршрутам, cooldown и last-good route, чтобы быстрее выбирать рабочий путь. Ручные режимы остаются предсказуемыми. Подробнее: [docs/ADAPTIVE_ROUTING.md](docs/ADAPTIVE_ROUTING.md).
