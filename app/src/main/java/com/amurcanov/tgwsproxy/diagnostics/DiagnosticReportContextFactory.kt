...
object DiagnosticReportContextFactory {
    ...
    suspend fun build(
        ...
        DiagnosticReportContext(
            ...
            workerHealthLastCheckAtMs = reportUi.workerHealthLastCheckAtMs,
            workerSelectionPreview = reportUi.workerSelectionPreview,
            enrichedRuntimeRoute = runtime,
            workerPoolUiSelectedWorkerMissing = reportUi.workerPoolSelectedWorkerMissing,
...
data class DiagnosticReportUiContext(
    ...
    val workerPoolSelectedWorkerMissing: Boolean = false,
    val workerPoolNoEnabledWorkers: Boolean = false,
    val workerPoolInvalidConfig: Boolean = false,
